...
$('.text-align-3').click(function() {
     $(this).parents('.case-grille').children('.container').css('text-align', 'right')
      ...
      $(this).parents('.case-grille').children('.container').css('background-color', '#FFFF00')
     });
      $('.background-red').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-color', '#FF0000')
     });
      $('.background-purple').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-color', '#B4BEF2')
     });
      $('.background-green').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-color', '#97D3C1')
     });
      $('.background-black').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-color', 'black')
     });
      $('.background-white').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-color', '#FFFFFF')
      });

      $('.image-small-1').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-image', 'url(img/selection/1.jpg)')
     });
      $('.image-small-2').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-image', 'url(img/selection/2.jpg)')
     });
      $('.image-small-3').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-image', 'url(img/selection/3.jpg)')
     });
      $('.image-small-4').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-image', 'url(img/selection/4.jpg)')
     });
      $('.image-small-5').click(function() {
      $(this).parents('.case-grille').children('.container').css('background-image', 'url(img/selection/5.jpg)')
     });
